...
protected:
 ...
 //   typedef CList<CWnd*, CWnd*>  CLinkedWndList;
    typedef std::list<CWnd*> CLinkedWndList;

    std::list<CWnd*> m_listLinkedWnds;    //  Registered linked window
    std::list<CWnd*>::iterator list_iter;
